...
export declare class ZetaGroupMarkets {
     ...
     */
    getOptionsMarketByExpiryIndex(expiryIndex: number, kind: Kind): Market[];
    /**
     * Returns the futures market given an expiry index.
     */
    getFuturesMarketByExpiryIndex(expiryIndex: number): Market;
    getMarketByExpiryKindStrike(expiryIndex: number, kind: Kind, strike?: number): Market | undefined;
    private constructor();
